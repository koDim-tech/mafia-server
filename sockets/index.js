...
import { handleMafiaVote }     from "../handlers/mafiaVote.js";
import { handleDoctorVote }     from "../handlers/doctorVote.js";
...
export function registerSocketHandlers(server) {
  ...
  io.on("connection", (socket) => {
    ...
    socket.on("mafiaVote",      safe(handleMafiaVote));
    socket.on("doctorVote",      safe(handleDoctorVote));
